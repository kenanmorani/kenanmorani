...
# Achievements
* Finally, web-apps for COVID-19 diagnosis with [our best method](https://github.com/IDU-CVLab/COV19D_3rd) are deployed: <br/> * using 2D grayscale medical slices is [here](https://kenanmorani-covid-19deployment-pipeline-app-82q4v6.streamlit.app/) <br/> * using full CT scan slices is [here](https://kenanmorani-covid-19deployment-patient-level-predictions-d37izn.streamlit.app/).
