...
# Achievements
* Finally a web-app for COVID-19 diagnosis with our best method's results from 2D grayscale medical slices is deployed using streamlit [here](https://kenanmorani-covid-19deployment-pipeline-app-82q4v6.streamlit.app/).
